...
def sendNZB(nzb):
    ...
    i=1
    logger.log(u"Testing SABnzb connectivity...")
    while TestCon("192.168.1.31",9090)=="Down" and i<4:
    	i=i+1
    	logger.log(u"sabnzbd host seems to be down - sending magic packet")
    	WakeOnLan('00:0c:76:50:a9:66')    
	time.sleep(20)
