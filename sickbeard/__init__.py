...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global ACTUAL_LOG_DIR, LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                ...
                SAB_HOST_MAC, SAB_WAKE_RETRIES, SAB_WAKE_TIMEOUT, \
                NZBGET_USERNAME, NZBGET_PASSWORD, NZBGET_CATEGORY, NZBGET_HOST, \
                NZBGET_HOST_MAC, NZBGET_WAKE_RETRIES, NZBGET_WAKE_TIMEOUT, currentSearchScheduler, backlogSearchScheduler, \
        ...
        SAB_HOST_MAC = check_setting_str(CFG, 'SABnzbd', 'sab_host_mac', '')
        SAB_WAKE_RETRIES = check_setting_int(CFG, 'SABnzbd', 'sab_wake_retries', 5)
        SAB_WAKE_TIMEOUT = check_setting_int(CFG, 'SABnzbd', 'sab_wake_timeout', 20)
...
def save_config():
    ...
    new_config['General']['display_all_seasons'] = DISPLAY_ALL_SEASONS
    ...
    new_config['SABnzbd']['sab_host_mac'] = SAB_HOST_MAC
    new_config['SABnzbd']['sab_wake_retries'] = SAB_WAKE_RETRIES
    new_config['SABnzbd']['sab_wake_timeout'] = SAB_WAKE_TIMEOUT
